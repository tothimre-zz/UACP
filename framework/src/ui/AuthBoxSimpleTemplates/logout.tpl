<form action="{HandlerUrl}" method="post">
	<div class="uacp_login" id="uacp_login_id">
		...
		<div class="uacp_user_sting_conatiner" id="uacp_user_stringt_conatiner_id">{UsernameLabel}</div>
		<div class="uacp_user_submit_conatiner" id="uacp_user_submit_conatiner_id">
			<input type="submit" name="{InputSubmitString}" value="Log Out" class="uacp_submit" id="uacp_submit_id">
		</div>
	</div>
</form>